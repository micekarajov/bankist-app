...
const account1 = {
	owner: 'Mice Karajov',
	movements: [5000, 2000, -2700, -530.35, 1020, 230, 5600, -70],
	interestRate: 1.5,
	pin: 1111,
...
btnLogin.addEventListener('click', function (e) {
	...
	if (currentAccount?.pin === +(inputLoginPin.value)) {
		...
		currentAccount.owner.split(' ')[0] //* print only the first name
		}`;
